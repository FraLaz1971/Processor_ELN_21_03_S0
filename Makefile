#############################################################################
# Makefile for building: processor_1032_15_15
# Project:  processor_1032_15_15
...
#SYSTEM: linux or QNX
SYSTEM = linux
PROJECT=processor_1644_21_03_S0
EXE_NAME = p2103S0.lnx
LIB_NAME =
...
INCPATH = -Iinclude -I$(GTB_CFITSIO_INCLUDE) -L$(GTB_CFITSIO_LIB) -I$(GTB_PACKETLIB_INCLUDE) -L$(GTB_PACKETLIB_LIB) -I$(GTB_COMMON_INCLUDE) -I$(GTB_PROCESSORLIB_INCLUDE) -L$(GTB_PROCESSORLIB_LIB)
#-I $(GTB_DISCOS_INCLUDE)
...
LIBS = -lstdc++ -lprocessor /opt/INAF/cfitsio/libcfitsio.a  -lpacket $(GTB_DISCOS_LIB)/libDISCoS.a
ifeq ($(SYSTEM), QNX)
	LIBS += -lsocket
endif
LINK     = g++
...
install: all
	...
	test -d $(datadir)/GSE_conf || mkdir -p $(datadir)/GSE_conf
	...
	$(COPY_FILE) conf/* $(datadir)/GSE_conf
